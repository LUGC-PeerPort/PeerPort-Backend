...
describe("GradeController test:", () => {
    ...
    describe("Update grade", () => {
        ...
        it.each([
            ...
            { name: "fails when minScore is invalid",                       value: { params: { gradeId: gradeId }, body: { minScore: "invalid", maxScore: 100, achievedScore: 50 } },   expectedStatus: 400, expectedResult: { message: "Invalid grade structure" } },
            { name: "fails when maxScore is invalid",                       value: { params: { gradeId: gradeId }, body: { minScore: 0, maxScore: "invalid", achievedScore: 50 } },     expectedStatus: 400, expectedResult: { message: "Invalid grade structure" } },
            { name: "fails when achievedScore is invalid",                  value: { params: { gradeId: gradeId }, body: { minScore: 0, maxScore: 100, achievedScore: "invalid" } },    expectedStatus: 400, expectedResult: { message: "Invalid grade structure" } },

            // Logical errors
            { name: "fails when grade does not exist",                      value: { params: { gradeId: "123e4567-e89b-12d3-a456-426614174000" } },                                     expectedStatus: 404, expectedResult: { message: "Grade not found" } },
            { name: "fails when minScore is negative",                      value: { params: { gradeId: gradeId }, body: { minScore: -1, maxScore: 100, achievedScore: 50 } },          expectedStatus: 400, expectedResult: { message: "Invalid minScore" } },
            { name: "fails when maxScore is less than minScore",            value: { params: { gradeId: gradeId }, body: { minScore: 1, maxScore: 0, achievedScore: 50 } },             expectedStatus: 400, expectedResult: { message: "Invalid maxScore" } },
            { name: "fails when achievedScore is less than minScore",       value: { params: { gradeId: gradeId }, body: { minScore: 1, maxScore: 100, achievedScore: 0 } },            expectedStatus: 400, expectedResult: { message: "Invalid achievedScore" } },
            { name: "fails when achievedScore is greater than maxScore",    value: { params: { gradeId: gradeId }, body: { minScore: 0, maxScore: 100, achievedScore: 101 } },          expectedStatus: 400, expectedResult: { message: "Invalid achievedScore" } },
            { name: "fails when updating maxScore below achievedScore",     value: { params: { gradeId: gradeId }, body: { maxScore: 10 } },                                            expectedStatus: 400, expectedResult: { message: "Invalid maxScore" } },
            { name: "fails when updating minScore above achievedScore",     value: { params: { gradeId: gradeId }, body: { minScore: 60 } },                                            expectedStatus: 400, expectedResult: { message: "Invalid minScore" } },
            { name: "fails when updating minScore above maxScore",          value: { params: { gradeId: gradeId }, body: { minScore: 110 } },                                           expectedStatus: 400, expectedResult: { message: "Invalid minScore" } },
            { name: "fails when updating maxScore below minScore",          value: { params: { gradeId: gradeId }, body: { maxScore: 0 } },                                             expectedStatus: 400, expectedResult: { message: "Invalid maxScore" } },
            { name: "fails when updating achievedScore below minScore",     value: { params: { gradeId: gradeId }, body: { achievedScore: 0 } },                                        expectedStatus: 400, expectedResult: { message: "Invalid achievedScore" } },
            { name: "fails when updating achievedScore above maxScore",     value: { params: { gradeId: gradeId }, body: { achievedScore: 110 } },                                      expectedStatus: 400, expectedResult: { message: "Invalid achievedScore" } },

            // Valid cases
            { name: "succeeds when updating minScore",                      value: { params: { gradeId: gradeId }, body: { minScore: 20 } },                                            expectedStatus: 200, expectedResult: { gradeId: gradeId, minScore: 20, maxScore: () => generalGrade.maxScore, achievedScore: () => generalGrade.achievedScore } },
            { name: "succeeds when updating maxScore",                      value: { params: { gradeId: gradeId }, body: { maxScore: 90 } },                                            expectedStatus: 200, expectedResult: { gradeId: gradeId, minScore: () => generalGrade.minScore, maxScore: 90, achievedScore: () => generalGrade.achievedScore } },
            { name: "succeeds when updating achievedScore",                 value: { params: { gradeId: gradeId }, body: { achievedScore: 50 } },                                       expectedStatus: 200, expectedResult: { gradeId: gradeId, minScore: () => generalGrade.minScore, maxScore: () => generalGrade.maxScore, achievedScore: 50 } },
            { name: "succeeds when updating all fields",                    value: { params: { gradeId: gradeId }, body: { minScore: 20, maxScore: 90, achievedScore: 50 } },           expectedStatus: 200, expectedResult: { gradeId: gradeId, minScore: 20, maxScore: 90, achievedScore: 50 } },

            // No changes
            { name: "succeeds when no fields are updated",                  value: { params: { gradeId: gradeId } },                                                                    expectedStatus: 200, expectedResult: { gradeId: gradeId, minScore: () => generalGrade.minScore, maxScore: () => generalGrade.maxScore, achievedScore: () => generalGrade.achievedScore } },
    ...
    describe("Get the calculated grade for a user in a specific course", () => {
        ...
        it.each([
            ...
            // Valid cases
            { name: "succeeds when user has no grades in course",           value: { params: { userId: () => user2.userId, courseId: () => course.courseId } },                         expectedStatus: 200, expectedResult: 0 },
            { name: "succeeds when user has multiple grades in course",     value: { params: { userId: () => user.userId, courseId: () => course.courseId } },                          expectedStatus: 200, expectedResult: () => generalGrade.achievedScore },
